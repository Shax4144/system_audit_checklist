...
function SidebarMenu({
  ...
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("flex w-full min-w-0 flex-col gap-0.5 px-3 py-5", className)}
      {...props} />
  );
}
