// routes/workspace/Reports/ReportDetail.jsx
				...
				<Tabs defaultValue="results">
					<div className="sticky top-16 z-10 bg-background pb-2">
						<TabsList className="gap-1">
							<TabsTrigger disabled value="results">Checklist Results</TabsTrigger>
							<TabsTrigger disabled value="audit-report">Audit Report</TabsTrigger>
						</TabsList>
					</div>
			...
			<div className="flex items-center gap-3">
				...
				<div>
					...
					<p className="text-sm text-muted-foreground">
						{info.supplier} — Ref. No. {info.reference_no}
					</p>
				</div>
			</div>
